...
import (
	...
	"github.com/Animesh-M-Deshpande/celeritas/cache"
...
func (c *Celeritas) New(rootPath string) error {
	...
	// check if the cache setup is empty
...
func (c *Celeritas) BuildDSN() string {
	...
	fmt.Println("connection string: databaseType:", os.Getenv("DATABASE_TYPE"))
	...
	case "postgres", "postgressql":
		...
		fmt.Println("connection string:2:", dsn)
	default:
