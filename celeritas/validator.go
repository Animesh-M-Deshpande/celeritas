...
func (v *Validation) Check(okay bool, key, message string) {
...
func (v *Validation) IsDate(field, value string) {
	_, err := time.Parse("2006-01-02", value)

	if err != nil {
		v.AddError(field, "this field must be in date format of YYYY-MM-DD")
	}
}
